...
创建一个 iframe，使用 iframe 的一个方法 postMessage 可以向[http://localhost:8081/b.html](https://link.zhihu.com/?target=http%3A//localhost%3A8081/b.html) 发送消息，然后监听 message，可以获得其他文档发来的消息。
